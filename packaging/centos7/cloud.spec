...
mvn -Psystemvm,developer -Dnoredist -DskipTests $FLAGS clean package
...
if [ ! -f %{_datadir}/cloudstack-common/scripts/vm/hypervisor/xenserver/vhd-util ] ; then
    echo Please download vhd-util from http://s3.download.accelerite.com/tools/vhd-util and put it in
