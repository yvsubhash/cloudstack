...
public interface SnapshotManager extends Configurable {
    ...
    static final ConfigKey<Boolean> usageSnapshotSelection = new ConfigKey<Boolean>("Usage", Boolean.class, "usage.snapshot.virtualsize.select", "false", "Set the value to true if snapshot usage need to consider virtual size, else physical size is considered ", false);
